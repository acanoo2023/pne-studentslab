class Seq:
    ...
    def __init__(self, strbases):
        ...
        self.strbases = strbases    # The sequence is stored in the object when the self.strbases = strbases line is executed.
        print("New sequence created!")

    def __str__(self):    # Los métodos __init__ y __str__ siempre son procesados se les llame o no.
